...
1.1.3 Actualizar Usuario
![](assets/registros/updateclient.png)
![](assets/registros/resultupdate.png)

1.1.4 Eliminar Usuario
![](assets/registros/deleteclient.png)
![](assets/registros/resultdelete.png)

# 1.2 Validaciones

1.2.1 Datos Sin Blancos
![](assets/registros/withoutblanks.png)

1.2.2 Datos con Estructura Solicitada
![](assets/registros/typefieldstables.png)

1.2.3 Registro Ya Existente
![](assets/registros/registeralreadyexist.png)

# 1.3 Registro de Servicios a Clientes

1[](assets/registros/createservice.png)
...
1.5.1 Tipo de Identificación Limitado
![](assets/registros/tipoidlimited.png)

1.5.2 Servicios Limitados
![](assets/registros/servicelimited.png)

1.5.3 Frontend/Backend
![](/assets/registros/home.png)
![](assets/registros/dockers.png)

1.5.4 Docker Compose Backend
![](assets/registros/dockercompose.png)

1.5.5 Estructura GitHub
